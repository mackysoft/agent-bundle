...
class BenchmarkTests(unittest.TestCase):
    ...
    def test_reports_are_private_safe_self_contained_and_have_required_charts(self):
        ...
        self.assertIn("case delta", reliability_chart)
        self.assertIn("95% confidence interval", reliability_chart)
        self.assertIn("paired estimate", reliability_chart)
        ...
        self.assertIn("Pilot hard-gate failures", pilot_svgs["pilot-hard-gates.svg"])
        self.assertIn("Pilot elapsed time", pilot_svgs["pilot-elapsed-time.svg"])
        self.assertIn("Pilot public API price estimate", pilot_svgs["pilot-public-price-cost.svg"])
        ...
        self.assertIn("case-001", pilot_svgs["pilot-elapsed-time.svg"])
        self.assertIn("reference", pilot_svgs["pilot-public-price-cost.svg"])
